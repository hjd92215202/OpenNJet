...
local endUserRouter = require("api_gateway.routes.end_user")
local realmRouter = require("api_gateway.routes.realm")
...
return function(app)
    ...
    app:use("/api_gateway/identities", endUserRouter())
    app:use("/api_gateway/identities", realmRouter())
