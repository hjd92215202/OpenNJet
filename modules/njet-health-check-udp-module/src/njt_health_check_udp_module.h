...
typedef struct njt_health_check_udp_match_s {
    njt_str_t                  send;      /* content need to send */
    njt_str_t                  expect;    /* expect string or binary */
} njt_health_check_udp_match_t;

typedef struct njt_health_check_udp_module_conf_ctx_s {
    njt_health_check_checker_t       *checker;     /* type operations */
    njt_health_check_udp_match_t               *match;       /* stream match rule */

    njt_str_t                         send;
    njt_str_t                         expect;

} njt_health_check_udp_module_conf_ctx_t;
